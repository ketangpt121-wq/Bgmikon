...
# Admin user IDs
admin_id = ["6120560770","6120560770"]
...
def start_attack_reply(message, target, port, time):
    ...
    keyboard.add(
        telebot.types.InlineKeyboardButton("SUPPORT", url="https://t.me/BGMIHACKPAIDTY")
    )
...
def show_plan(message):
   ...
   # response += "- Pro Plan: $20/month\n"
    ...
    response = "- Know our services from @BGMIHACKPAIDTY\n"
...
"""
    keyboard = telebot.types.InlineKeyboardMarkup()
    keyboard.row(
        telebot.types.InlineKeyboardButton('Updates', url='https://t.me/BGMIHACKPAIDTY'),
        telebot.types.InlineKeyboardButton('Support', url='https://t.me/BGMIHACKPAIDTY')
    )
